...
class ProduitsController extends Controller
{
    public function produitsAction(Categories $categorie = null)
    {
        ...
        $produits = $this->get('knp_paginator')->paginate($findProduits,$this->get('request')->query->get('page', 1),6); //pagination
    ...
    public function presentationAction($id)
    {
        ...
        if (!$produit) throw $this->createNotFoundException('Page Does not exist.');
    ...
    public function rechercheTraitementAction()
    {
        ...
        $produits = $this->get('knp_paginator')->paginate($produits,$this->get('request')->query->get('page', 1),6); //pagination
