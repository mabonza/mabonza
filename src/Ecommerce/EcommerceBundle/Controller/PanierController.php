...
class PanierController extends Controller
{
    ...
    public function supprimerAction($id)
    {
        ...
        if (array_key_exists($id, $panier))
        {
            ...
            $this->get('session')->getFlashBag()->add('success','Article successfully removed');
        }
    ...
    public function ajouterAction($id)
    {
        ...
        if (array_key_exists($id, $panier)) {
            ...
            $this->get('session')->getFlashBag()->add('success','Quantity successfully changed');
        } else {
            ...
            $this->get('session')->getFlashBag()->add('success','Item added successfully');
        }
