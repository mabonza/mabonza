...
class appProdProjectContainer extends Container
{
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_1849ad763c904a9f88f320b1eded91bc3fb1716986212e738b166f59d7dc8fd3');
        return $instance;
    }
    ...
    protected function getTwigService()
    {
        ...
        $instance->addGlobal('telephone', '(012) 342 3840');
        $instance->addGlobal('fax', '086 999 0200');
        $instance->addGlobal('adresse', '312 Pretorius Str, Hatfield, Pretoria. P.O. Box 6574, Pretoria, 0001');
        return $instance;
    }
