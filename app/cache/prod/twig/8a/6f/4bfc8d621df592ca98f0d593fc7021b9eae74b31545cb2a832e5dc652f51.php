...
class __TwigTemplate_8a6f4bfc8d621df592ca98f0d593fc7021b9eae74b31545cb2a832e5dc652f51 extends Twig_Template
{
    ...
    <form action=\"";
        // line 6
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("adminProduits_update", array("id" => $this->getAttribute((isset($context["entity"]) ? $context["entity"] : null), "id", array()))), "html", null, true);
        echo "\" method=\"POST\" ";
